...
public class LambdaMain {
	...
	public static void main(String[] args) {
		...
		Arrays.sort(ar, (o1, o2) -> o2.compareTo(o1));//인터페이스를 구현한 객체
