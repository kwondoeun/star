...
public class Main {
	...
	public static void main(String[] args) {
		try (//인스턴스 단위에 파일에 기록할 수 있는 객체를 생성
			...
			//기록할 인스턴스 생성
			StudentDTO dto1 = new StudentDTO(1, "쇼콜라", new Date());
			StudentDTO dto2 = new StudentDTO(2, "피에르", new Date());
			
			//기록할 인스턴스가 여러개 이므로 하나의 List로 묶어줍니다.
