...
public class ArrayEx {
	public static void main(String[] args) {
		...
		//5. 배열의 모습을 문자열로 확인하는 명령문(외우기)
		System.out.println(Arrays.toString(arr));                         //5~8번까지 외우기
		...
		int[] arr8= new int[3];
		arr8[0] = (int)(Math.random()* 10) +1;
		arr8[1] = (int)(Math.random()* 10) +1;
		arr8[2] = (int)(Math.random()* 10) +1;
